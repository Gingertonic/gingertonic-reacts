...
export default ({ title, description, image, secureImage }) => {
    return (
        <Helmet>
            ...
            <title>{title ? `${title} | GRWR` : "Gingertonic Reacts"}</title>
            <meta name="description" content={description || "A Webpack / React / Jest / Enzyme boilerplate"} />
            ...
            <meta property="twitter:description" content={description || "A Webpack / React / Jest / Enzyme boilerplate"} />
            <meta property="twitter:title" content={title || "Gingertonic Reacts"} />
